                            ...
                            <div class="col-md-12">
                                <div class="panel panel-white">
                                    <div class="panel-heading clearfix">
                                        <h4 class="panel-title">商品分类修改/Rectify Commodity Classification</h4>
                                    </div>
                                        ...
                                        <div class="row">
                                         <div class="col-md-2">
                                                <div class="control-group">
                                                    <div class="controls">
                                                    	<label class="control-label">分类ID </label><font color="red">*</font>
		...
		$(document).ready(function() {
			 $("#rec").click(function(){
	        	...
	        	var id = $('#class_id').val();
		          //设置linkToCart的href的值
		          $.ajax({
               url:"/commodity_manage_system/recClassification",
               data:{
               ...
               success:function(data){
               	if(data > 0){
               		alert("操作成功");
               		 window.location.href='/commodity_manage_system/listClassification';
               	}
               	else{
               		alert("操作失败");
               	}
	    ...
	    $("#delButton").on("click", function() {  
	        ...
	        swal({  
	            ...
	            if(isConfirm.value !=true) {  
	            	...
	            	$.ajax({
	                       url: "/commodity_manage_system/delClassification",
	                       data:{
	                         	"cat.class_name":class_name,
	                         	"cat.id":id,
	                         	"cat.remarks":remarks,
